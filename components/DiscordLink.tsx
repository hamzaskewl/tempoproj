export function DiscordLink({ size = 14 }: { size?: number }) {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="text-[13px] text-[#5865F2] px-[12px] py-1 border border-[#5865F233] rounded flex items-center gap-[5px] hover:border-[#5865F2] hover:bg-[#5865F211] transition-colors"
    >
